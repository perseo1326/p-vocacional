...
// *************************************************************************
// funcion para mostrar/ocultar un panel div
function esconderPanel(id)
{
	let panel = document.getElementById(id);
	panel.classList.toggle("esconder");
	console.log("Esconder Panel => ", id);
}
...
if (x == false) {
	...
	elemId.className = "ancho errores";
}
}
...
if (error != false) {
	p1.className = p2.className = "ancho errores";
} else {
...
if (x == false) {
	...
	elemId.className = claseModoNormal + " errores";
}
//console.log(elemId)
}
